 ...
 */
package com.silentpulse.messenger.feature.backup
...
import com.silentpulse.messenger.common.util.extensions.getLabel
import com.silentpulse.messenger.common.util.extensions.setBackgroundTint
import com.silentpulse.messenger.common.util.extensions.setPositiveButton
...
import com.silentpulse.messenger.model.BackupFile
...
class BackupController : QkController<BackupView, BackupState, BackupPresenter>(), BackupView {
    ...
    private val backup: PreferenceView get() = rootView.findViewById(R.id.backup)
    private val empty: QkTextView get() = rootView.findViewById(R.id.empty)
    private val fab: LinearLayout get() = rootView.findViewById(R.id.fab)
    private val fabIcon: ImageView get() = rootView.findViewById(R.id.fabIcon)
    private val fabLabel: QkTextView get() = rootView.findViewById(R.id.fabLabel)
    private val files: RecyclerView get() = rootView.findViewById(R.id.files)
    private val linearLayout: LinearLayout get() = rootView.findViewById(R.id.linearLayout)
    private val progress: ConstraintLayout get() = rootView.findViewById(R.id.progress)
    private val progressBar: ProgressBar get() = rootView.findViewById(R.id.progressBar)
    private val progressCancel: ImageView get() = rootView.findViewById(R.id.progressCancel)
    private val progressIcon: ImageView get() = rootView.findViewById(R.id.progressIcon)
    private val progressSummary: QkTextView get() = rootView.findViewById(R.id.progressSummary)
    private val progressTitle: QkTextView get() = rootView.findViewById(R.id.progressTitle)
    private val restore: PreferenceView get() = rootView.findViewById(R.id.restore)
    private val titleView: QkTextView get() = rootView.findViewById(R.id.titleView)
    ...
    private val backupFilesDialog by lazy {
        ...
        val filesView = dialogView.findViewById<RecyclerView>(R.id.files)
        val emptyView = dialogView.findViewById<QkTextView>(R.id.empty)
        filesView.adapter = adapter.apply { this.emptyView = emptyView }
