...
import com.silentpulse.messenger.common.MenuItem
...
import com.silentpulse.messenger.common.widget.TextInputDialog
import com.silentpulse.messenger.feature.settings.about.AboutController
import com.silentpulse.messenger.feature.settings.autodelete.AutoDeleteDialog
import com.silentpulse.messenger.feature.settings.swipe.SwipeActionsController
import com.silentpulse.messenger.feature.themepicker.ThemePickerController
...
class SettingsController : QkController<SettingsView, SettingsState, SettingsPresenter>(), SettingsView {
    ...
    private val about: PreferenceView get() = rootView.findViewById(R.id.about)
    ...
    private val longAsMms: PreferenceView get() = rootView.findViewById(R.id.longAsMms)
    ...
    private val systemFont: PreferenceView get() = rootView.findViewById(R.id.systemFont)
    private val textSize: PreferenceView get() = rootView.findViewById(R.id.textSize)
    private val themePreview: View get() = rootView.findViewById(R.id.theme)
    private val unicode: PreferenceView get() = rootView.findViewById(R.id.unicode)
