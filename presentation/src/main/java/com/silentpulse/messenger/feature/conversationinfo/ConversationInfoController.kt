...
import com.silentpulse.messenger.feature.conversationinfo.injection.ConversationInfoModule
...
class ConversationInfoController(
    ...
    private val recyclerView: RecyclerView get() = rootView.findViewById(R.id.recyclerView)
