...
import com.silentpulse.messenger.common.util.extensions.forwardTouches
import com.silentpulse.messenger.common.util.extensions.setBackgroundTint
import com.silentpulse.messenger.common.util.extensions.setPadding
...
import com.silentpulse.messenger.compat.SubscriptionManagerCompat
import com.silentpulse.messenger.extensions.isSmil
import com.silentpulse.messenger.extensions.isText
import com.silentpulse.messenger.feature.compose.BubbleUtils.canGroup
import com.silentpulse.messenger.feature.compose.BubbleUtils.getBubble
import com.silentpulse.messenger.feature.compose.part.PartsAdapter
...
class MessagesAdapter @Inject constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QkViewHolder {
        ...
        return QkViewHolder(view).apply {
            view.setOnClickListener {
                ...
                when (toggleSelection(message.id, false)) {
                    ...
                    false -> {
                        ...
                        val statusView = view.findViewById<QkTextView>(R.id.status)
            ...
            view.setOnLongClickListener {
                val message = getItem(bindingAdapterPosition) ?: return@setOnLongClickListener true
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        cancel?.let { cancelView ->
            val isCancellable = message.isSending() && message.date > System.currentTimeMillis()
            cancelView.setVisible(isCancellable)
            cancelView.clicks().subscribe { cancelSending.onNext(message.id) }
            cancelView.progress = 2
            ...
            if (isCancellable) {
                ...
                ObjectAnimator.ofInt(cancelView, "progress", progress.toInt(), 100)
        ...
        val simIcon = holder.itemView.findViewById<ImageView>(R.id.sim)
        ...
        simIcon.setVisible(message.subId != previous?.subId && subscription != null && subs.size > 1)
