...
class BlockedNumbersController : QkController<BlockedNumbersView, BlockedNumbersState, BlockedNumbersPresenter>(),
    ...
    private val add: ImageView get() = rootView.findViewById(R.id.add)
    private val empty: QkTextView get() = rootView.findViewById(R.id.empty)
    private val input: QkEditText get() = rootView.findViewById(R.id.input)
    private val numbers: RecyclerView get() = rootView.findViewById(R.id.numbers)
