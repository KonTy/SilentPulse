...
import com.silentpulse.messenger.interactor.DeleteOldMessages
...
import com.silentpulse.messenger.service.AutoDeleteService
...
class SettingsPresenter @Inject constructor(
    ...
    private fun sttEngineLabel(engine: String) = when (engine) {
        "vosk" -> "Vosk (Offline)"
        "futo" -> "FUTO Voice (Offline)"
        else   -> "Android (Google Offline)"
    }
