...
import com.silentpulse.messenger.interactor.MarkUnpinned
import com.silentpulse.messenger.interactor.MarkUnread
import com.silentpulse.messenger.interactor.MigratePreferences
import com.silentpulse.messenger.interactor.SyncContacts
import com.silentpulse.messenger.interactor.SyncMessages
...
import com.silentpulse.messenger.model.SyncLog
    ...
    override fun bindView(view: MainView) {
        ...
        view.conversationsSelectedIntent
                .withLatestFrom(state) { selection, state ->
                    ...
                    val pin = conversations.count { !it.pinned } >= conversations.count { it.pinned }
                    val read = conversations.count { !it.unread } >= conversations.count { it.unread }
