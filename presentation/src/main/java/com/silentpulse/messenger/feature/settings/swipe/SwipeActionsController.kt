 ...
 */
package com.silentpulse.messenger.feature.settings.swipe
...
class SwipeActionsController : QkController<SwipeActionsView, SwipeActionsState, SwipeActionsPresenter>(), SwipeActionsView {
    ...
    private val left: ConstraintLayout get() = rootView.findViewById(R.id.left)
    private val leftIcon: ImageView get() = rootView.findViewById(R.id.leftIcon)
    private val leftLabel: QkTextView get() = rootView.findViewById(R.id.leftLabel)
    private val right: ConstraintLayout get() = rootView.findViewById(R.id.right)
    private val rightIcon: ImageView get() = rootView.findViewById(R.id.rightIcon)
    private val rightLabel: QkTextView get() = rootView.findViewById(R.id.rightLabel)
