 ...
 */
package com.silentpulse.messenger.feature.changelog
...
class ChangelogAdapter(private val context: Context) : QkAdapter<ChangelogAdapter.ChangelogItem>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QkViewHolder {
        ...
        return QkViewHolder(view).apply {
            if (viewType == 0) {
                val changelogItem = itemView.findViewById<QkTextView>(R.id.changelogItem)
    ...
    override fun onBindViewHolder(holder: QkViewHolder, position: Int) {
        ...
        val changelogItem = holder.itemView.findViewById<QkTextView>(R.id.changelogItem)
