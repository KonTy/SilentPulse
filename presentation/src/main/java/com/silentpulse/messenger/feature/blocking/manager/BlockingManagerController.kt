package com.silentpulse.messenger.feature.blocking.manager
...
import com.silentpulse.messenger.feature.blocking.manager.BlockingManagerPreferenceView
...
class BlockingManagerController : QkController<BlockingManagerView, BlockingManagerState, BlockingManagerPresenter>(),
    ...
    private val callBlocker: BlockingManagerPreferenceView get() = rootView.findViewById(R.id.callBlocker)
    private val callControl: BlockingManagerPreferenceView get() = rootView.findViewById(R.id.callControl)
    private val qksms: BlockingManagerPreferenceView get() = rootView.findViewById(R.id.qksms)
    private val shouldIAnswer: BlockingManagerPreferenceView get() = rootView.findViewById(R.id.shouldIAnswer)
