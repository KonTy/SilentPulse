...
class Navigator @Inject constructor(
    ...
    fun showRating() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.silentpulse.messenger"))
        ...
        try {
            ...
            val url = "http://play.google.com/store/apps/details?id=com.silentpulse.messenger"
    ...
    fun showInvite() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/KonTy/SilentPulse"))
        startActivityExternal(intent)
    }
