 ...
 */
package com.silentpulse.messenger.common.widget
...
class GroupAvatarView @JvmOverloads constructor(
    ...
    private val avatar1: AvatarView get() = findViewById(R.id.avatar1)
    private val avatar1Frame: FrameLayout get() = findViewById(R.id.avatar1Frame)
    private val avatar2: AvatarView get() = findViewById(R.id.avatar2)
