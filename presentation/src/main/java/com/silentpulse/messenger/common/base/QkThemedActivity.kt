...
import com.silentpulse.messenger.common.util.extensions.resolveThemeBoolean
...
abstract class QkThemedActivity : QkActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        @Suppress("DEPRECATION") // systemUiVisibility, navigationBarColor, TaskDescription deprecated on API 29+
