...
class ReceiveSmsTest {
    ...
    @Mock private lateinit var dropPref: com.moez.QKSMS.util.Preferences.Preference<Boolean>
    @Mock private lateinit var blockingManagerPref: com.moez.QKSMS.util.Preferences.Preference<Int>
