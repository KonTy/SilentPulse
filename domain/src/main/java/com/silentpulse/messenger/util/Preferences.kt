 ...
 */
package com.silentpulse.messenger.util
...
import com.silentpulse.messenger.common.util.extensions.versionCode
...
class Preferences @Inject constructor(
    ...
    val driveModeWhisperModelPath = rxPrefs.getString("drivemode_whisper_model_path", "")
    // BCP-47 language code passed to Whisper inference (e.g. "en", "fr").
    // Empty string → Whisper auto-detects the language.
